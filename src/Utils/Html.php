...
class Html
{
    ...
    function val_display($text = '', $title = '', $class = '', $code = 0)
    {
        $out = "";
    ...
    function area_display($text = '', $title = '', $class = '', $code = 0, $rows = 10)
    {
        $out = "";
        if ($title != '') {
            $out .= "<h3>$title</h3>";
        }
        $out .= "<textarea class='span12 $class' rows=$rows>";
        if ($code == 0) {
            $out .= htmlspecialchars(print_r($text, true));
        } else {
            $out .= htmlspecialchars(var_export($text, true));
